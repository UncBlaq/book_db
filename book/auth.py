...
from book.schemas import BookCreate, BookUpdate, Book, UserCreate, TokenData
...
def authenticate_user(db: db_dependency, username : str, password : str):
    user = book.crud.get_user_by_username(db, username)
...
def get_current_user(db : db_dependency, token: str = Depends(oauth2_scheme)):
    ...
    user = book.crud.get_user_by_username(db, token_data.username)
